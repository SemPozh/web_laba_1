...
public class Validator {
    ...
    public static HashMap<String, Number> validateRequestJsonParams(String JSONRequest) throws ValidationException {
        try {
            ...
            if (!isIntegerInRange(map.get("x"), -5, 3)) {
            ...
            if (!((map.get("y").doubleValue() < 3) && (map.get("y").doubleValue() > -3))) {
